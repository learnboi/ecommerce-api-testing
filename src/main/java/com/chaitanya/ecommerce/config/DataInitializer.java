...
public class DataInitializer {
    ...
    CommandLineRunner seed(UserRepository users, ProductRepository products) {
        return args -> {
            ...
            if (products.count() == 0) {
                products.save(new Product("Wireless Mouse", "2.4GHz wireless mouse",
                        new BigDecimal("799.00"), 50, "Accessories"));
                products.save(new Product("Mechanical Keyboard", "RGB mechanical keyboard",
                        new BigDecimal("2499.00"), 25, "Accessories"));
                products.save(new Product("USB-C Cable", "Fast charging USB-C cable",
                        new BigDecimal("399.00"), 100, "Cables"));
            }
        };
    }
}
